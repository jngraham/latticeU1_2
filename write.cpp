...
int write(double* avg_plaquette_data, double* jpc_plus_data, double* jpc_minus_data, double* flux_data){
  ...
  for (size_t i = 0; i < N_samples; i++){
    ...
    for (size_t t = 0; t < Lt; t++){
      ...
      flux_re_output << flux_data[2*Lt*i + 2*t] << ",";
      flux_im_output << flux_data[2*Lt*i + 2*t + 1] << ",";
    }
