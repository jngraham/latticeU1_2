...
double avg_plaquette(double* lattice, int Lx, int Ly, int Lt);
...
double jpc_plus(double* lattice, int Lx, int Ly, int t);

double jpc_minus(double* lattice, int Lx, int Ly, int t);

double flux(double* lattice, int Lx, int Ly, int t);
